...
public class BasicDocument extends Document 
{
	...
	public int getNumSyllables()
	{
		...
		//String[] documentWords = documentText.split("[ .?!]+");
		
		List<String> documentWords = getTokens("[a-zA-z]+");
		int sumSyllables = 0; 
		//System.out.println(documentWords.length);
		for(String testWord: documentWords)
		{ int wordSyllables = countSyllables(testWord);
			sumSyllables +=wordSyllables;
			//System.out.println(sumSyllables);
		}
