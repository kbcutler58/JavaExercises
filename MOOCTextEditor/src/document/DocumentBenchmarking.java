	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for (int i = 0; i < trials; i++)
			{
				...
				BasicDocument basic1 = new BasicDocument(text1);
				double temp1 = basic1.getFleschScore();
			...
			for (int i = 0; i < trials; i++)
			{
				EfficientDocument efficient1 = new EfficientDocument(text1);
				double temp2 = efficient1.getFleschScore();
			}
